  ...
  exports.default = {
    ...
    methods: {
      ...
      getFormatDate: function getFormatDate() {
        ...
        if (this.isTwelveHours) {
          var halfHour = columnValues.splice(columnValues.length - 1, 1)[0];
