...
(function (global, factory) {
...
})(this, function (exports, _popup, _titleBar, _radio, _util) {
  'use strict';
  ...
  exports.default = {
    ...
    components: (_components = {}, _defineProperty(_components, _radio2.default.name, _radio2.default), _defineProperty(_components, _popup2.default.name, _popup2.default), _defineProperty(_components, _titleBar2.default.name, _titleBar2.default), _components),
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"md-selector",class:{
  ...
  }},[_c('md-popup',{attrs:{"position":"bottom","mask-closable":false,"prevent-scroll":true},on:{"show":function($event){_vm.$emit('show')},"hide":function($event){_vm.$emit('hide')}},model:{value:(_vm.isSelectorShow),callback:function ($$v) {_vm.isSelectorShow=$$v},expression:"isSelectorShow"}},[_c('md-popup-title-bar',{attrs:{"title":_vm.title,"ok-text":_vm.okText,"cancel-text":_vm.cancelText},on:{"confirm":_vm.$_onSelectorConfirm,"cancel":_vm.$_onSelectorCancel}}),_vm._v(" "),_c('div',{staticClass:"md-selector-container"},[_c('div',{staticClass:"md-selector-list"},[_c('md-radio',{key:_vm.radioKey,ref:"radio",attrs:{"options":_vm.data,"default-index":_vm.defaultIndex,"invalid-index":_vm.invalidIndex,"icon":"circle-right","icon-inverse":"circle","icon-size":"md","optionRender":_vm.optionRender,"is-slot-scope":_vm.hasSlot},on:{"change":_vm.$_onSelectorChoose},scopedSlots:_vm._u([{key:"default",fn:function(ref){
