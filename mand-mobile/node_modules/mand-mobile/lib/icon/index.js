...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.name)?_c('svg',{staticClass:"md-icon",class:[("md-icon-" + _vm.name), _vm.size],style:({fill: _vm.color})},[_c('use',{attrs:{"xlink:href":("#" + _vm.name)}})]):_vm._e()}
