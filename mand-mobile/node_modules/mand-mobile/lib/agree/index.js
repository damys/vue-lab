...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"md-agree",class:[
  ...
  ]},[_c('div',{staticClass:"agree-icon",class:[
      _vm.value ? 'checked' : ''
    ],on:{"click":function($event){_vm.$_onChange($event)}}},[_c('md-icon',{attrs:{"name":_vm.iconName,"size":_vm.size}})],1),_vm._v(" "),_vm._t("default")],2)}
